...
## Recent Updates
- **Hero Section Enhancements**: Updated hero card images to feature yacht-relevant destinations, integrated a sleek Play icon overlay directly on the active card, implemented a custom golden trailing cursor effect, removed the "Est. 2024" badge for a cleaner look, and added a continuous rotating and floating animation to the hero card stack.
