...
- **Conversion & Visual Immersions**: Integrated an official white Zen Sea logo in the Navigation bar. Implemented a sleek full-screen Video Modal view replacing the traditional 'Watch Film' text link in Hero. Added new CTAs anchoring to the fleet within the 'Love Letter' section, and injected bespoke video indicator icons onto the collection cards.
