        ...
        <section className="relative h-screen min-h-[700px] lg:min-h-[850px] w-full flex items-center justify-center overflow-hidden">
            ...
            <div className="relative z-20 text-center px-6 max-w-6xl mx-auto flex flex-col items-center mt-12">
                <div className="relative reveal-on-scroll opacity-0 translate-y-12 scale-95 rotate-2">
                    <span className="font-[family-name:var(--font-caveat)] text-4xl md:text-6xl text-[#C5A880] -rotate-6 block mb-4 ml-4 drop-shadow-[0_4px_12px_rgba(0,0,0,0.8)]">
                        Let the currents guide you...
                    </span>
                    <h1 className="text-6xl sm:text-8xl lg:text-[9rem] font-[family-name:var(--font-playfair)] text-white mb-2 leading-[0.9] drop-shadow-[0_10px_30px_rgba(0,0,0,0.8)] relative inline-block">
                        Write Your Story <br />
                ...
                <p className="text-white/90 text-lg md:text-2xl font-light max-w-3xl mb-12 mt-10 reveal-on-scroll opacity-0 translate-y-12 drop-shadow-md" style={{ transitionDelay: '200ms' }}>
                ...
                <div className="flex flex-col sm:flex-row gap-6 lg:gap-8 reveal-on-scroll opacity-0 translate-y-12" style={{ transitionDelay: '300ms' }}>
                    <button
                        ...
                        className="px-10 lg:px-12 py-4 lg:py-5 bg-[#C5A880] text-white text-sm tracking-[0.2em] uppercase font-bold hand-drawn-fill border-2 border-transparent hover:bg-[#0077b6] transition-all duration-500 transform hover:-translate-y-1 hover:rotate-2 shadow-[0_0_30px_rgba(197,168,128,0.4)] hover:shadow-[0_0_30px_rgba(0,119,182,0.6)]"
                    >
                        Meet The Fleet
                    </button>
                    <button
                        onClick={() => openModal('Hero: Watch Film')}
                        className="px-10 lg:px-12 py-4 lg:py-5 text-white text-sm tracking-[0.2em] uppercase font-bold hand-drawn hover:bg-white hover:text-slate-900 transition-all duration-500 backdrop-blur-md bg-white/5 flex items-center justify-center gap-3 border-white/50"
                    >
